...
class Td extends Tag
{
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		$this->cssManager->cell_border_dominance_R = 0;
		$this->cssManager->cell_border_dominance_T = 0;
		$this->cssManager->cell_border_dominance_B = 0;
		...
		if (isset($properties['BORDER'])) {
			...
			if ($bord['s']) {
				if (!$this->mpdf->simpleTables) {
					...
					$c['border_details']['L']['dom'] = $this->cssManager->cell_border_dominance_L;
					$c['border_details']['R']['dom'] = $this->cssManager->cell_border_dominance_R;
					$c['border_details']['T']['dom'] = $this->cssManager->cell_border_dominance_T;
					$c['border_details']['B']['dom'] = $this->cssManager->cell_border_dominance_B;
				} elseif ($this->mpdf->simpleTables && $this->mpdf->row == 0 && $this->mpdf->col == 0) {
